# Generated by Django 3.0.2 on 2020-01-04 19:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_seo_ru', models.CharField(blank=True, max_length=500, null=True, verbose_name='Title Seo')),
                ('title_seo_en', models.CharField(blank=True, max_length=500, null=True, verbose_name='Title Seo')),
                ('meta_keywords', models.TextField(blank=True, null=True, verbose_name='Keywords')),
                ('meta_keywords_ru', models.TextField(blank=True, null=True, verbose_name='Keywords')),
                ('meta_keywords_en', models.TextField(blank=True, null=True, verbose_name='Keywords')),
                ('meta_description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('meta_description_ru', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('meta_description_en', models.TextField(blank=True, null=True, verbose_name='Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_author', to=settings.AUTH_USER_MODEL)),
                ('category', models.ManyToManyField(blank=True, related_name='product_categories', to='shop.Category', verbose_name='Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='similar_product', to='shop.Product', verbose_name='Product')),
                ('products', models.ManyToManyField(related_name='similar_products', to='shop.Product', verbose_name='Products')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', optimized_image.fields.OptimizedImageField(upload_to='', verbose_name='Image')),
                ('photo_alt', models.CharField(blank=True, max_length=255, verbose_name='Description image')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='photo_product', to='shop.Product', verbose_name='Product')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='color',
            field=models.ManyToManyField(related_name='product_colors', to='shop.ProductColor', verbose_name='Colors'),
        ),
    ]
