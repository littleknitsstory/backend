    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', models.CharField(blank=True, choices=[('_blank', '_blank'), ('_top', '_top'),
                                                                 ('_parent', '_parent')], max_length=10, null=True)),
                ...
                ('menu', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='menu',
                                           to='menu.Menu', verbose_name='Menu type')),
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True,
                                                      on_delete=django.db.models.deletion.CASCADE,
                                                      related_name='children', to='menu.MenuItems')),
            ],
            options={
